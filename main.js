...
console.log(myFriends);// ["Yvette", "Carla", "Jack", "Courtney", "Bernard"]
...
allFriends[2] = 'Corinthia';//Tell javascript which index you want to target and the new value.
...
for (let i = 0; i < words.length; i++) {
  ...
  console.log(element);//Returns values as a collection (list format? )
}
